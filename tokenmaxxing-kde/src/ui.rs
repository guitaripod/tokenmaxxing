...
impl AppUi {
    pub fn new(app: &adw::Application, from_ui: Sender<FromUi>) -> Self {
        ...
        let window = adw::ApplicationWindow::builder()
            ...
            .build();
        window.add_css_class("tokenmaxxing");
        ...
        header.set_title_widget(Some(&adw::WindowTitle::new("tokenmaxxing", "token quotas")));
    ...
    pub fn update(&self, snapshots: &[Snapshot]) {
        *self.0.latest.borrow_mut() = snapshots.to_vec();
        ...
        self.0
            .updated
            .set_text(&format!("updated {now}   ·   tokenmaxxing 0.1.0"));
    }
